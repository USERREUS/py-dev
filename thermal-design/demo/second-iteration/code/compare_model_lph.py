...
def technical_condition_lph(t2в_DT,t2в_real,k_DT,k_real,tk_DT,tk_real,delta_P_DT,delta_P_real, pH, Элект, O2):
    ...
    O2_max = 20
    O2_min = 10
    Z_ph = abs((ph_max - pH)/ (ph_max - ((ph_max - ph_min)*0.5)-((pH-(ph_max - ph_min)*0.5)/pH)*(ph_max - ph_min)*0.5))
    Z_Элект = abs((Элект_max - Элект)/ (Элект_max - ((Элект_max - Элект_min)*0.5)-((Элект-(Элект_max - Элект_min)*0.5)/Элект)*(Элект_max - Элект_min)*0.5))
    Z_O2 = abs((O2_max - O2)/ (O2_max - ((O2_max - O2_min)*0.5)-((O2-(O2_max - O2_min)*0.5)/O2)*(O2_max - O2_min)*0.5))
